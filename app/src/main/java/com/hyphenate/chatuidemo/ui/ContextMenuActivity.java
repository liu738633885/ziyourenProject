...
public class ContextMenuActivity extends HxBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (type == EMMessage.Type.TXT.ordinal()) {
		    if(message.getBooleanAttribute(HuanXinConstants.MESSAGE_ATTR_IS_VIDEO_CALL, false) ||
		            message.getBooleanAttribute(HuanXinConstants.MESSAGE_ATTR_IS_VOICE_CALL, false)
//					|| message.getBooleanAttribute(RedPacketConstant.MESSAGE_ATTR_IS_RED_PACKET_MESSAGE, false)
					){
		        setContentView(R.layout.em_context_menu_for_location);
		    }else if(message.getBooleanAttribute(HuanXinConstants.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)){
