...
public class PickContactNoCheckboxActivity extends HxBaseActivity {
	...
	private void getContactList() {
		...
		while (iterator.hasNext()) {
			...
			if (!entry.getKey().equals(HuanXinConstants.NEW_FRIENDS_USERNAME) && !entry.getKey().equals(HuanXinConstants.GROUP_USERNAME) && !entry.getKey().equals(HuanXinConstants.CHAT_ROOM) && !entry.getKey().equals(HuanXinConstants.CHAT_ROBOT))
