...
public class DemoDBManager {
    ...
    synchronized public Map<String, EaseUser> getContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (username.equals(HuanXinConstants.NEW_FRIENDS_USERNAME) || username.equals(HuanXinConstants.GROUP_USERNAME)
                        || username.equals(HuanXinConstants.CHAT_ROOM)|| username.equals(HuanXinConstants.CHAT_ROBOT)) {
    ...
    public synchronized Integer saveMessage(InviteMessage message){
        ...
        if(db.isOpen()){
            ...
            values.put(InviteMessgeDao.COLUMN_AVATOR, message.getAvator());// 添加头像
            values.put(InviteMessgeDao.COLUMN_NAME_FROM_ID, message.getFromId());// 添加申请人
    ...
    synchronized public List<InviteMessage> getMessagesList(){
        ...
        if(db.isOpen()){
            ...
            while(cursor.moveToNext()){
                ...
                String avator = cursor.getString(cursor.getColumnIndex(InviteMessgeDao.COLUMN_AVATOR));// 取的时候添加头像
                String fromId = cursor.getString(cursor.getColumnIndex(InviteMessgeDao.COLUMN_NAME_FROM_ID));// 取的时候添加申请人
