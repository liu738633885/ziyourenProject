...
public class UserProfileManager {
	...
	public synchronized boolean init(Context context) {
		...
		MyParseManager.getInstance().onInit(context);
	...
	public void asyncGetCurrentUserInfo() {
		MyParseManager.getInstance().asyncGetCurrentUserInfo(new EMValueCallBack<EaseUser>() {
	...
	public void asyncGetUserInfo(final String username, final EMValueCallBack<EaseUser> callback){
		MyParseManager.getInstance().asyncGetUserInfo(username, callback);
	}
	...
	private String getCurrentUserNick() {
		return UserManager.getKeyNickname();
		//return PreferenceManager.getInstance().getCurrentUserNick();
	}

	private String getCurrentUserAvatar() {
		return UserManager.getKeyAvatar();
